...
$sql = "SELECT * FROM menu WHERE jenis_menu = 'Makanan' AND status_menu='Sedia';";
$makanan = $conn->query($sql);

$sql1 = "SELECT * FROM menu WHERE jenis_menu = 'Minuman' AND status_menu='Sedia';";
$minuman = $conn->query($sql1);

$sql2 = "SELECT * FROM menu WHERE jenis_menu = 'Penutup'  AND status_menu='Sedia';";
$penutup = $conn->query($sql2);

$sql3 = "SELECT * FROM menu WHERE jenis_menu = 'Kudapan'  AND status_menu='Sedia';";
...
function displayMenu($result)
{
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<div class="text-[10px] text-gray-400 pt-9">Untuk ' . htmlspecialchars($row["kapasitas_menu"]) . ' Orang</div>';
        ...
        echo "Menu Tidak Tersedia Untuk Saat ini";
    }
}
    ...
    <div class="bg-langit w-screen h-[620px] overflow-hidden overflow-x-hidden">
        ...
        <div class="flex flex-row items-center h-[528px]">
            ...
            <div class="basis-5/12 grid grid-cols-2">
                ...
                <div class="w-[350px] my-2 col-start-2 text-ungu font-bold">
    ...
    <div id="modalPesan"
        ...
        <div class="w-1/2 h-[650px] bg-white rounded-3xl border shadow-xl">
            ...
            <div class="bg-white mx-16 h-[500px] mb-6 rounded-3xl shadow-xl border over">
                <div class="bg-white mx-3 h-[330px] mt-2 overflow-scroll" id="order-list">
                ...
                <div class="px-9 flex items-center justify-between mx-auto font-semibold text-lg my-4">
                    ...
                    <input type="text" id="customer-name" class="shadow"> <!-- Tambahkan ID -->
                </div>
